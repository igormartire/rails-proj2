...
c1 = Comment.create(:user_id => u5.id, :item_id => i1.id, :text => "Hi, is there any scratch on that?")
c2 = Comment.create(:user_id => u1.id, :item_id => i1.id, :text => "Yes, there is a little scratch on the right side.")
c3 = Comment.create(:user_id => u4.id, :item_id => i1.id, :text => "Could you upload an image of that?")
c4 = Comment.create(:user_id => u1.id, :item_id => i1.id, :text => "Done.")
c5 = Comment.create(:user_id => u3.id, :item_id => i5.id, :text => "Comment Line 1.\nComment Line 2;\nComment Line 3.")
c6 = Comment.create(:user_id => u2.id, :item_id => i9.id, :text => "Comment Line 1.\nComment Line 2;\nComment Line 3.")
