  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        "p",
        null,
        React.createElement("input", { ref: "username", name: "comment[username]", placeholder: "Your name" })
      ),
      React.createElement(
        "p",
        null,
      ...
      React.createElement(
        "p",
        null,
        React.createElement("input", { type: "hidden", name: "comment[item_id]", value: this.props.form.id })
      ),
      React.createElement(
        "p",
        null,
...
var CommentList = React.createClass({
  ...
  render: function () {
    var commentNodes = this.props.comments.map(function (comment) {
      return React.createElement(Comment, { username: comment.username, text: comment.text, key: comment.id });
    });
